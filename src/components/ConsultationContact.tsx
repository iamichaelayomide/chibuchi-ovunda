  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-12 pattern-grid-blush border-b border-[#09090b]/15">
      <div className="max-w-2xl mx-auto text-center">
        ...
        {/* Center-Aligned iOS Rounded Card */}
        <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 sm:p-12 border border-[#09090b]/15 shadow-xl text-left">
          
          {submitted ? (
            <div className="text-center py-8">
              <div className="w-12 h-12 rounded-2xl bg-[#09090b] text-[#f5cad5] flex items-center justify-center mx-auto mb-4 font-heading font-bold text-lg shadow-sm">
                ✓
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-[#09090b] text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#6b1728] active:scale-[0.97] transition-all shadow-md group"
              >
