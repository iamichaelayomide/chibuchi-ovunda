    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-40 w-11 h-11 rounded-xl bg-[#0b0b0b] text-white flex items-center justify-center shadow-xl hover:bg-[#a83254] active:scale-[0.93] transition-all duration-150 group focus:outline-none"
