...
export const Hero: React.FC<HeroProps> = ({ onSelectServiceForConsult }) => {
  return (
    <section className="relative pt-32 pb-20 sm:pt-36 sm:pb-28 px-4 sm:px-6 lg:px-12 bg-[#faf9f5] border-b border-[#e4e4e7] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            {/* Monospace Index & Status Tag */}
            <motion.div
              initial={{ opacity: 0, y: 8 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.35, ease: [0.23, 1, 0.32, 1] }}
              className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-white border border-[#e4e4e7] shadow-xs w-fit mb-6"
            >
              <span className="w-2 h-2 rounded-full bg-emerald-600 animate-pulse"></span>
              <span className="text-[11px] font-mono font-semibold uppercase tracking-wider text-[#09090b]">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-6xl lg:text-7xl font-serif font-bold text-[#09090b] tracking-tight leading-[1.06] mb-6"
            >
            ...
            >
              I partner with attorneys, advocates, and commercial law practices to structure matter files, draft court-compliant agreements, streamline client intake, and safeguard billable hours.
            </motion.p>
            ...
            >
              ...
              <a
                href="#work"
                className="px-6 py-3.5 rounded-full bg-white border border-[#e4e4e7] text-[#09090b] text-xs font-bold uppercase tracking-wider hover:bg-[#f4f4f5] hover:border-[#d4d4d8] active:scale-[0.97] transition-all duration-160 shadow-xs"
              >
            ...
            <motion.div
              ...
              className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 border-t border-[#e4e4e7]"
            >
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-white border border-[#e4e4e7] flex items-center justify-center text-[#6b1728] shrink-0 shadow-xs">
                  <Lock className="w-3.5 h-3.5" />
                </div>
                <div>
                  <p className="text-xs font-bold text-[#09090b]">Strict NDA</p>
                  <p className="text-[11px] text-[#71717a]">Confidentiality Standard</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-[#09090b]">&lt; 2h Response</p>
                  <p className="text-[11px] text-[#71717a]">Priority Matter SLA</p>
                </div>
              </div>
            </motion.div>
          ...
          {/* Right Column: Architectural Portrait Frame */}
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            ...
            >
              ...
              <div className="p-3.5 bg-white border border-[#e4e4e7] rounded-3xl shadow-md">
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 sm:-left-6 bg-[#09090b] text-white p-3.5 rounded-2xl border border-[#27272a] shadow-xl flex items-center gap-3"
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#a1a1aa]">Attorneys & Practices</p>
                </div>
              </motion.div>
